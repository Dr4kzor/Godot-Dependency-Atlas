...
const FlyCamera = preload("res://addons/orphan_finder/graph3d/fly_camera.gd")
const TypeIcons = preload("res://addons/orphan_finder/graph3d/type_icons.gd")
const GraphMetrics = preload("res://addons/orphan_finder/graph3d/graph_metrics.gd")
const CodeLinks = preload("res://addons/orphan_finder/graph3d/code_links.gd")
...
const FilterWindow = preload("res://addons/orphan_finder/graph3d/filter_window.gd")
...
func _run_scan() -> void:
	...
	if layout_problem != "":
		push_warning("Orphan Finder: " + layout_problem)
	_load_settings()
