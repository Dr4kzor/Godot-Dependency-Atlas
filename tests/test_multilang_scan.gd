...
func _run() -> void:
	...
	_expect("res://project.godot" in root_paths, "project settings root missing")
	...
	_expect("res://icon.svg" in graph.get("res://project.godot", []), "project config resource edge missing")
